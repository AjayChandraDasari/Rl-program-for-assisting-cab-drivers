...
class CabDriver():
    ...
    def requests(self, state):
        ...
        #the driver is free to refuse all customer requests. Hence, adding the index of action (0,0).
        actions.append([0,0])
    ...
    def next_state_func(self, state, action, Time_matrix):
        ...
        # Initialize various time division
        total_time   = 0
        transit_time = 0    # time taken to go from current location to pickup location
        wait_time    = 0    # time taken in case driver has to wait before another booking
        ride_time    = 0    # time taken from Pick-up to drop
        ...
        if ((pickup_loc== 0) and (drop_loc == 0)):
            ...
            new_time, new_day = self.updated_time_day(curr_time, curr_day, transit_time)
        ...
        next_time, next_day = self.updated_time_day(curr_time, curr_day, total_time)
    ...
    def updated_time_day(self, time, day, ride_duration):
        """
